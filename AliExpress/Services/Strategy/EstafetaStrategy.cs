...
{
    public class EstafetaStrategy : IParcelLogistics
    {
        public List<ITransport> lstTransport { get; set; }

        public string cParcel { get { return "Estafeta"; } }

        public decimal dUtility { get { return 20; } }

        private readonly IProcessMessagesServices _processMessages;

        public EstafetaStrategy(IProcessMessagesServices processMessages)
        {
