...
{
    public class DHLStrategy : IParcelLogistics
    {
        public List<ITransport> lstTransport { get; set; }

        public string cParcel { get { return "DHL"; } }

        public decimal dUtility { get { return 40; } }

        private readonly IProcessMessagesServices _processMessages;

        public DHLStrategy(IProcessMessagesServices processMessages)
        {
